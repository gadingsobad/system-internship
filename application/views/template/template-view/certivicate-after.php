            ...
            <div class="card h-100 m-b">
                <div class="card-body">
                    ...
                    <div class=" col text-center">
                        <a href=" <?= site_url('certifikate/print') ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Lihat</a>
                        <a href="<?= site_url('certifikate/print') ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="background-color: #15499a;">Unduh</a>
                    </div>
                </div>
                <!--end::content-->
            </div>
