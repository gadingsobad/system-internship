...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
            ...
            <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
                ...
                <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                    ...
                    <a href="https://soloabadi.com/" class="text-center pt-2">
                        <div class="logo">
                            <img src="<?= base_url('assets/metronic-v7/') ?>media/solo-abadi/logo-sobad.png" class="max-h-40px" alt="" />
                        </div>
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside body-->
            ...
            <div class="content order-1  d-flex flex-column w-100 p-0 m-0" style="background-image: url('<?= base_url('assets/metronic-v7/') ?>media/solo-abadi/sobad-login-rev.jpg');background-repeat: round;">
            </div>
        </div>
        <div class="logo1">
            <a href="https://soloabadi.com/">
                <img src="<?= base_url('assets/metronic-v7/') ?>media/solo-abadi/logo-sobad-white.png" class="max-h-40px" alt="" />
            </a>
        </div>
        <!--end::Login-->
    </div>
